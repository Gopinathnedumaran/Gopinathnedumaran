...
def list_mongodb_collection_names(database):
    gopi = pymongo.MongoClient(
        "mongodb+srv://Gopinath:1234@cluster0.hsxthhn.mongodb.net/")
    db = gopi[database]
...
def sql_create_tables():
    gopi_sql = psycopg2.connect(host='localhost', user='gopinath', password='1234', database='YouTube_project')
...
def list_sql_channel_names():
    gopi = psycopg2.connect(host='localhost', user='gopinath', password='1234', database='YouTube_project')
    cursor = gopi.cursor()
...
def sql_videos(database, col_input):
    gopi_mdb = pymongo.MongoClient(
        "mongodb+srv://Gopinath:12343@cluster0.hsxthhn.mongodb.net/")
    db = gopi_mdb[database]
    col = db[col_input]
